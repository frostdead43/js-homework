...
// 100 TL'lik satış bedelini toplam satış bedeli için kdv dahil 120 TL olarak hesaplarız. Eğer maliyet olduysa (satış bedeli - maliyet) + kdv olacak.,
...
// let ProductCost = Number(prompt("enter Product Cost"));


// let kdv = ((salePrice) * 30) / 100;


// let incomeTax = ((salePrice + kdv) * 25) / 100 ;

// let result = (((salePrice - ProductCost) + kdv) - incomeTax);
